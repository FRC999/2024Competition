...
public class AutoCRNCBlueMid3LowShootAnyways extends SequentialCommandGroup {
  /** Creates a new AutoBlueBottom3Notes. */
  public AutoCRNCBlueMid3LowShootAnyways() {
 ...
 /*              ,
      ...
      //  (
          new DeferredCommand(
            ...
            TrajectoryHelpers.getCorrectedPose(),
            autoPoses.BLUE_SPEAKER_MID_RETURN.getPose())
            , Set.of()
            )
            .deadlineWith(
                new ArmTurnToAngle(() -> RobotContainer.gpmHelpers.getGPM0Angle(0))
