...
public final class Constants {
	...
	public static final class AutoConstants {
		...
		public static enum autoPoses {	// important poses
			...
			RED_SPEAKER_HIGHER(13.492, 6.352, -60),
			RED_SPEAKER_MID(13.789, 5.514, 0),
			RED_SPEAKER_LOWER(13.992, 4.667, 60),

			RED_HIGHER_POS_OUT(11.453, 7.1, 0),
			RED_MID_POS_OUT(11.453, 5.540, 0),
			RED_LOWER_POS_OUT(11.453, 1.32, 0)
			;
			private Pose2d pose;
