...
public class AutoCRedHigher2REVNonStop extends SequentialCommandGroup {
  /** Creates a new AutoREDBottom3Notes. */
  public AutoCRedHigher2REVNonStop() {
    ...
    addCommands(
        ...
        // go back to speaker
        new AutonomousTrajectory2Poses( // drive to original position and turn arm to angle preemptively to reduce
                                        // shooting cycle
            autoPoses.RED_HIGHER_RING_TAKE_END.getPose(),
            autoPoses.RED_SPEAKER_HIGHER.getPose())
            .deadlineWith(
