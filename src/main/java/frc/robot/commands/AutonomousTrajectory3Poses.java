 ...
 */
public class AutonomousTrajectory3Poses extends SequentialCommandGroup {
  /**
   * Run a trajectory between 2 poses with max velocity and acceleration
   * @param startPose
   * @param endPose
   */
  public AutonomousTrajectory3Poses( Pose2d startPose, Pose2d midPose, Pose2d endPose) {
   ...
   */
  public AutonomousTrajectory3Poses( Pose2d startPose, Pose2d midPose, Pose2d endPose, double maxVelocity, double maxAcceleration) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    ...
    addCommands(
      new RunTrajectorySequenceRobotAtStartPoint(
        PathPlanner.generatePath(
          ...
          new PathPoint(midPose.getTranslation(), new Rotation2d(0), midPose.getRotation()), // position, heading
